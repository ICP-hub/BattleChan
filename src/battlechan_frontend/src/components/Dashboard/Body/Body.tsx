    ...
    >
      ...
      <div
        className={
          className +
          "__postsNumber" +
          ` laptop:hidden flex flex-col gap-2 p-4 big_tablet:p-10 big_tablet:px-10 mx-4 big_tablet:mx-16 big_tablet:my-24 my-10 border border-dark dark:border-light rounded-xl`
        }
      >
      ...
      <div className="w-auto relative hidden laptop:flex items-center justify-center overflow-x-auto xl:my-20 my-10 p-10 border border-dark dark:border-light rounded-xl mx-16 no-scrollbar">
