...
export default class App extends React.PureComponent<IAppProps> {
  public render() {
    return (
      <div className='bg-[#0A0A0A] w-full  font-istok text-white py-9'>
        ...
        <div className=' w-full sm: mt-[5px] mb-6 flex flex-wrap justify-between '>
          ...
          <div className=' flex  items-center flex-wrap '>
            ...
            <div className="hidden md:block relative ml-3 px-[50px]">
              <input type="text" placeholder="Search here..." className="py-1.5 pl-[40px] pr-2.25 rounded-full bg-black border-1 placeholder-[#FFFFFF80] text-white w-[551px] h-[48px] text-sm font-normal" />
          ...
          <div className=' hidden md:flex items-center'>
            <div className='rounded-[3rem]  border-green-500 border-[0.1px]  flex items-center  py-[5px]'>
              <div className='flex ml-[22px] text-[20px]'>
                <div className='font-[700] '>1 $Time Token:</div>
                <div className='text-green-500 ml-1.5'>$0.0050</div>
              </div>
              <div className='bg-white text-black  font-[700] text-[18px]  text-center px-[38px] py-[11px] rounded-[2rem] mx-[11px]'>Buy</div>
            </div>
            <div className='ml-3'>
