  ...
  return (
    <React.Fragment>
      <label
        className={
          className +
          " themeSwitcherThree relative inline-flex cursor-pointer select-none items-center transition ease-in duration-200"
        }
      >
        <input
          type="checkbox"
        ...
        />
        <div
          className={`shadow-card flex h-[46px] w-[82px] items-center justify-center rounded-[2rem] bg-${props.lightColor}`}
        >
          <span
