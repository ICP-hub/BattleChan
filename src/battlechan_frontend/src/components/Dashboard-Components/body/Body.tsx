        ...
        return (
            ...
            <div className='min-h-screen bg-black text-white'>
                ...
                <div className='flex  font-[700]  sm:pt-[76px]  '>
                    ...
                    <div className='text-white font-[400] text-[24px] sm:w-[630px] sm:h-[72px]' >Welcome to BattleChan, where every post battles for supremacy </div>
                </div>

                <div className=' sm:py-[100px] sm:px-[200px] border sm:mx-[100px] flex text-white font-[400] text-[30px] text-md justify-center'>
                ...
                <div className=' border-[0.5px] m-[25px] border-white px-[15px] rounded-md mt-5 pt-[20px] pb-[20px]'>
