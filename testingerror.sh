...
dfx canister call backend getPostInfo '("#3982738165")'
...
dfx canister call backend upvoteOrDownvotePost '("#3982738165", variant { upvote  })'
dfx canister call backend getPostInfo '("#3982738165")'
...
dfx canister call backend createComment '("#3982738165","sample")';



dfx identity use default

dfx canister call backend withdrawPost '("#3982738165",1)'
