...
# dfx canister call backend getPostInfo '("#3302885542")'
...
dfx canister call backend upvoteOrDownvotePost '("#3302885542", variant { upvote  })'
# dfx canister call backend getPostInfo '("#3302885542")'
...
# dfx canister call backend createComment '("#3302885542","sample")';
...
# dfx canister call backend withdrawPost '("#3302885542",1)'
# dfx canister call backend getPostInfo '("#3302885542")'
