...
import { idlFactory } from './battle_chan_frontend.did.js';
export { idlFactory } from './battle_chan_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.BATTLE_CHAN_FRONTEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./battle_chan_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the battle_chan_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./battle_chan_frontend.did.js")._SERVICE>}
 */
export const battle_chan_frontend = createActor(canisterId);
